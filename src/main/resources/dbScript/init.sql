...
USE [HaoWu]
GO
/****** Object:  Table [dbo].[CombinedQuestion]    Script Date: 2020/11/20 23:15:29 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[CombinedQuestion](
 ...
 CONSTRAINT [PK_CombinedQuestion] PRIMARY KEY CLUSTERED
(
	[ID] ASC
...
GO
/****** Object:  Table [dbo].[HotWord]    Script Date: 2020/11/20 23:15:29 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Question]    Script Date: 2020/11/20 23:15:29 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[QuestionContent]    Script Date: 2020/11/20 23:15:29 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[QuestionContent](
	[ID] [varchar](128) NOT NULL,
	[CombinedQuestionID] [varchar](128) NOT NULL,
	[FollowerCount] [bigint] NULL,
	[BrowserCount] [bigint] NULL,
	[CreateTime] [datetime] NULL,
 CONSTRAINT [PK_QuestionContent] PRIMARY KEY CLUSTERED
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TopCategory]    Script Date: 2020/11/20 23:15:29 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[XZSE86]    Script Date: 2020/11/20 23:15:29 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[XZSE86](
 ...
 CONSTRAINT [PK_XZSE86] PRIMARY KEY CLUSTERED
(
	[ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
SET ANSI_PADDING OFF
GO
INSERT [dbo].[CombinedQuestion] ([ID], [TopCategoryID], [HotWordID], [URL], [Name], [CreateTime]) VALUES (N'014e1b00-d36b-4159-9133-f3be900002fa', N'6AC1705C-1BCB-49F6-AB19-46667E13A1CB', N'4F03AAE4-FA74-47E8-A59D-305DE39A6276', N'https://www.zhihu.com/question/428055072', N'想买颜值高的保温饭盒，而且要保温效果很好的那种，求推荐？', CAST(0x0000AC79013167FC AS DateTime))
GO
INSERT [dbo].[CombinedQuestion] ([ID], [TopCategoryID], [HotWordID], [URL], [Name], [CreateTime]) VALUES (N'07f3ff01-cec5-4689-852d-4cf17f35b644', N'6AC1705C-1BCB-49F6-AB19-46667E13A1CB', N'1A749203-A9DF-4BD7-AFC5-6FFAC6D20E89', N'https://www.zhihu.com/question/22726851', N'哪个牌子的保温饭盒保温效果最好？', CAST(0x0000AC79013167BD AS DateTime))
GO
...
GO
INSERT [dbo].[QuestionContent] ([ID], [CombinedQuestionID], [FollowerCount], [BrowserCount], [CreateTime]) VALUES (N'7b5e842d-66b7-4c14-97e0-e3e067daa5ca', N'07f3ff01-cec5-4689-852d-4cf17f35b644', 140, 362691, CAST(0x0000AC79017E8D47 AS DateTime))
GO
INSERT [dbo].[QuestionContent] ([ID], [CombinedQuestionID], [FollowerCount], [BrowserCount], [CreateTime]) VALUES (N'a2143287-b069-4ab4-950f-d30027279115', N'014e1b00-d36b-4159-9133-f3be900002fa', 10, 596, CAST(0x0000AC79017E699E AS DateTime))
GO
